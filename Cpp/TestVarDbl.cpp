...
{
    assertEquals(VarDbl(0) / VarDbl(1), 0, 0);
    assertEquals(VarDbl(1) / VarDbl(1),   1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(-1) / VarDbl(1), -1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(1) / VarDbl(-1), -1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(-1) / VarDbl(-1), 1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(2) / VarDbl(1),   2, ulp(2)*VarDbl::DEVIATION_OF_LSB);

    assertEquals(VarDbl(1.0) / VarDbl(1), 1, std::sqrt(2)*ulp(1.0)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(2.0) / VarDbl(1), 2, std::sqrt(2)*ulp(2.0)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(0.5) / VarDbl(1), 0.5, std::sqrt(2)*ulp(0.5)*VarDbl::DEVIATION_OF_LSB);

    assertEquals(VarDbl(1.0) / VarDbl(1.0), 1, std::sqrt(3)*ulp(1.0)*VarDbl::DEVIATION_OF_LSB, 0, 5.30e-22);
    assertEquals(VarDbl(2.0) / VarDbl(1.0), 2, std::sqrt(3)*ulp(2.0)*VarDbl::DEVIATION_OF_LSB, 0, 1.06e-21);
    assertEquals(VarDbl(0.5) / VarDbl(1.0), 0.5, std::sqrt(3)*ulp(0.5)*VarDbl::DEVIATION_OF_LSB, 0, 2.65e-22);
...
{
    assertEquals(VarDbl(0)/ 1.0, 0, 0);
    assertEquals(VarDbl(1)/ 1.0,   1, std::sqrt(2)*ulp(1)*VarDbl::DEVIATION_OF_LSB, 0, 6.5e-22);
    assertEquals(VarDbl(-1)/ 1.0, -1, std::sqrt(2)*ulp(1)*VarDbl::DEVIATION_OF_LSB, 0, 6.5e-22);
    assertEquals(VarDbl(1)/ -1.0, -1, std::sqrt(2)*ulp(1)*VarDbl::DEVIATION_OF_LSB, 0, 6.5e-22);
    assertEquals(VarDbl(-1)/ -1.0, 1, std::sqrt(2)*ulp(1)*VarDbl::DEVIATION_OF_LSB, 0, 6.5e-22);
    assertEquals(VarDbl(2)/ 1.0,   2, 2*std::sqrt(2)*ulp(1)*VarDbl::DEVIATION_OF_LSB, 0, 1.3e-21);

    assertEquals(VarDbl(0.5)/ 1.0, 0.5, std::sqrt(3)*ulp(0.5)*VarDbl::DEVIATION_OF_LSB, 0, 2.65e-22);
    assertEquals(VarDbl(1.0)/ 1.0, 1.0, std::sqrt(3)*ulp(1.0)*VarDbl::DEVIATION_OF_LSB, 0, 5.30e-22);
    assertEquals(VarDbl(2.0)/ 1.0, 2.0, std::sqrt(3)*ulp(2.0)*VarDbl::DEVIATION_OF_LSB, 0, 1.06e-21);
...
void testFloatByVarDblOne() 
{
    ...
    assertEquals(1 / VarDbl(1),   1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(-1 / VarDbl(1), -1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(1 / VarDbl(-1), -1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(-1 / VarDbl(-1), 1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(2 / VarDbl(1),   2, ulp(2)*VarDbl::DEVIATION_OF_LSB);

    assertEquals(0.5 / VarDbl(1), 0.5, std::sqrt(2)*ulp(0.5)*VarDbl::DEVIATION_OF_LSB);
...
void testVarDblByVarDblTwo() 
{
    ...
    assertEquals(VarDbl(1) / VarDbl(2),   0.5, ulp(0.5)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(-1) / VarDbl(2), -0.5, ulp(0.5)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(1) / VarDbl(-2), -0.5, ulp(0.5)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(-1) / VarDbl(-2), 0.5, ulp(0.5)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(2) / VarDbl(2),     1, ulp(1)*VarDbl::DEVIATION_OF_LSB);
    assertEquals(VarDbl(0.5) / VarDbl(2), 0.25, std::sqrt(2)*ulp(0.25)*VarDbl::DEVIATION_OF_LSB);
