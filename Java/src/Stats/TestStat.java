...
public class TestStat extends Stat {
	...
	public void test() {
		...
		Assert.assertFalse( accum( Double.NaN ) );
		Assert.assertFalse( accum( Double.POSITIVE_INFINITY ) );
		Assert.assertFalse( accum( Double.NEGATIVE_INFINITY ) );
