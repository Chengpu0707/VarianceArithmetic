...
Figure \ref{fig: Forward_Error_vs_Size_Noise} shows the error deviation of a typical value test: the error deviation decreases linearly with increasing input uncertainty deviation $\delta x$ at a constant rate of $-1$, because the values should match unless at $\delta x \rightarrow 0$ when floating-point rounding errors dominate.
