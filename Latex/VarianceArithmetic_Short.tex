...
Figure \ref{fig: Normal_Function} shows that the stable ideal leakages for the selected functions are less than $10^{-4}$ for $\hat{\delta^2} f$, which is small enough for most applications. 
\ifdefined\Verbose
