...
$\kappa_s = 5$ and $\kappa_s = \sqrt{3}$ are defined as the \emph{ideal bounding ranges} $\hat{\kappa}$ for the uniform and Gaussian distributions respectively.
The bound moment $\zeta(n, \hat{\kappa})$ calculated by the ideal bounding range $\hat{\kappa}$ is defined as the \emph{ideal bound moment}.
