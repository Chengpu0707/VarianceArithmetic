...
For $x = \pm 0.6, 0.7$, after $r(N)$ reach $LSV$ of $1/(1-x)$, the $LSV$ equal the corresponding expansion uncertainties, respectively. 
For $x = -0.7$, $r(N)$ does not reach $LSV$, leaving the least two significant bits incorrect, which shows that traditional numerical Taylor expansion is less accurate than its theoretical claim.
...
\captionof{figure}{
The absolute reminder values and the expansion uncertainties for Taylor expansion of $\frac{1}{1 -x  \pm \delta x}$, for different Taylor expansion order $N$ as shown in the x-axis, and different input $x \pm \delta x$ as shown in the legend.
In the legend,  
\textit{Reminder Value} is the value of Formula \eqref{eqn: Taylor expansion reminder}, 
\textit{Expansion LSV} is the $LSV$ of the value of Formula \eqref{eqn: Taylor expansion},
\textit{Expansion Uncertainty} is the uncertainty of Formula \eqref{eqn: Taylor expansion}.
...
\captionof{figure}{
The truncation errors order to achieve $3\;10^{-7}$ reminder precision for Taylor expansion of $\frac{1}{1 - x \pm \delta x}$, for different input precision $\delta x$ as shown in the x-axis, and different imprecise $x$ as shown in the legend.
In the legend,  
\textit{Reminder Error} means when the absolute value change from $e(N-1)$ to $e(N)$ is less than $\tau$-fold of the uncertainty of $1(1-x)$, 
\textit{Stability} means to use the stability criterion to decide maximal $N$ for $e(N)$.
}
