...
The convergence of the result variance calculation can be judged numerically, such as requiring variance terms of Formula \eqref{eqn: power precision} at $2n$ to decrease faster than $1/P(x)^{2n}$ for the $x^c$.
