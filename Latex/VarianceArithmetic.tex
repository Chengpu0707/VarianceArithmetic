...
\item For $2n < 10$ when $5 \leq \sigma$, Formula \eqref{eqn: momentum factor lower} can be approximated by $\zeta(2n) = (2n-1)!!$.  
...
P(e^x)^2 &= \sum_{n=1}^{\infty} (\delta x)^{2n} \zeta(2n) \sum_{j=1}^{2n-1} \frac{1}{j!\;(2n - j)!}
