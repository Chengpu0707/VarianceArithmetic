...
\captionof{figure}{
The measured deviation vs calculated uncertainty for $\exp(x \pm \delta x)$, for different $\delta x$ as shown in the legend, in which "Error" means the measured error deviation, and "Uncertainty" means the uncertainties from variance arithmetic. 
}
\label{fig: Exp_Dev}
\end{figure}
...
\captionof{figure}{
The measured deviation vs calculated uncertainty for $\log(x \pm \delta x)$, for different $\delta x$ as shown in the legend, in which "Error" means the measured error deviation, and "Uncertainty" means the uncertainties from variance arithmetic. 
}
\label{fig: Log_Dev}
\end{figure}
...
\captionof{figure}{
The measured deviation vs calculated uncertainty for $\sin(x \pm \delta x)$, for different $\delta x$ as shown in the legend, in which "Error" means the measured error deviation, and "Uncertainty" means the uncertainties from variance arithmetic. 
}
\label{fig: Sin_Dev}
\end{figure}
...
\captionof{figure}{
The measured vs calculated uncertainty deviation for $(1 \pm \delta x)^c$, for different $\delta x$ as shown in the legend, in which "Error" means the measured error deviation, and "Uncertainty" means the uncertainties from variance arithmetic. 
...
\captionof{figure}{
The measured probability density of $(1 \pm \delta x)^{exp}$ for different $exp$ and $\delta x$ as shown in the legend. 
The $x$-axis is the normalized deviation from the mean of $(1 \pm \delta x)^{exp}$.
...
At each point, the result error deviation is obtained by 10000 samples using a library function, the result uncertainty is calculated by the variance arithmetic.
...
\captionof{figure}{
The result error deviations and error maximums using Sin and Cos signals vs. FFT order for forward, reverse and roundtrip FFT transformations, as shown in the legend.
}
...
\captionof{figure}{
The real and imaginary absolute value errors and uncertainties in the FFT spectrum of a clean Sin signal of order 6 and index frequency 7, as shown in the legend.
}
...
\captionof{figure}{
The real and imaginary absolute value errors and uncertainties in the FFT spectrum of a Sin signal of order 6 and index frequency 7 with $10^{-16}$ white noises, as shown in the legend.
}
...
\captionof{figure}{
The result error maximums using Sin and Cos signals of order 18 vs. input uncertainties for forward, reverse and roundtrip FFT transformations using either Gaussian noise or white noise, as shown in the legend.
}
