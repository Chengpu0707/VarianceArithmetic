...
For these functions, the statistical nature of variance arithmetic means that there is some probability for $\tilde{x} \leq 0$ so that the result is not defined.
