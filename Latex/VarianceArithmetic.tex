...
The mystery is that the Java implementation is one order of magnitude faster than the C++ implementation, even though the C++ implementation has \textit{-O3} optimization.
