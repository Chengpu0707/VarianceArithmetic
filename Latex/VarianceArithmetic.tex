...
\begin{figure}
\includegraphics[height=2.75in]{FFT_Unfaithful.png} 
...
Using the maximal absolute value errors, Figure \ref{fig: Sin_Cot_Diff} compares the value error strengths of the library $\sin(x)$ and $1/\tan(x)$ for different FFT orders.
Numerically, the library $\sin(x)$ and $1/\tan(x)$ do not have proper coverage.
