...
For Linear signals, when comparing Figure \ref{fig: FFT_Linear_Clean_Histo_Prec} and \ref{fig: FFT_Linear_Clean_Histo_Indexed} for the normalized error distributions:
\begin{itemize}
